...
def build_healthgait_dataset_from_config(config, *, _validated_samples=None):
...
def build_sequential_healthgait_loaders(config, datasets, *, pin_memory=False):
    """Build deterministic, non-dropping loaders for feature extraction."""
    worker_options = (
